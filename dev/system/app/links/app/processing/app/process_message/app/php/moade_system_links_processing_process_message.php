 ...
 * ----     SEND MESSAGE TO DATA TO ASK FOR PROCESS ID IN PROCESS TABLE IN PRIORITY ORDER TO LOAD IN MESSAGE PROCESSOR
 * ----     CHANGE STATUS TO PROCESS_MESSAGE IN STATUS SCHEMA
 ...
 * ----     CHANGE STATUS TO PROCESS_MESSAGE
 * ---  ELSE IF CURRENT STATUS IS PROCESS_MESSAGE
 ...
 * -- CHECK IF DATA SERVICE IS ACTIVE (RUNNING)
 * -- IF TRUE
 * ---  SEND MESSAGE TO DATA TO LOAD PROCESS_ID IN MESSAGE_PROCESSOR BY ADDING PROCESS ID OF MESSAGE IN MESSAGE PROCESSOR  WITH STATUS RUNNING
 * -- ELSE
