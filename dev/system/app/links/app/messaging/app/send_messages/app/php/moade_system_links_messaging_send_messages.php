 ...
 * ----     SEND MESSAGE TO DATA TO ASK FOR INBOX MESSAGES WITH STATUS SEND
 ...
 * ----     CHANGE STATUS TO SEND_MESSAGES
 * ---  ELSE IF CURRENT STATUS IS SEND_MESSAGES
 * ----     GOTO SEND_MESSAGES
 * ---  ELSE
 * ----     CHANGE STATUS TO SEND_MESSAGES
 * --  
 ...
 * -- CHECK IF DATA SERVICE IS ACTIVE (RUNNING)
 * -- IF TRUE
 * ---  SEND MESSAGE TO DATA TO SEND INBOX MESSAGE TO DESTINATION QUEUE MESSAGE
 * -- ELSE
